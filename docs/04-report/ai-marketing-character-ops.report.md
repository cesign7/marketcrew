...
| `/data` HTTP smoke | 200 OK, data contract and source field anchors visible |
...
| Missing data contract visibility | Added `/data` contract panel for incoming fields, source field lists, stored fields, samples, and safety notes | Resolved |
...
- Provider data contract panel for incoming data, source field lists, stored data, column descriptions, and sample values.
