...
describe("product image studio project wizard UI", () => {
  it("renders the usable Korean wizard controls on the first studio screen", () => {
    ...
    expect(html).toContain("상품 설정");
    expect(html).toContain("개별 규격 상품");
    expect(html).toContain("세트 규격 상품");
    expect(html).toContain("저장된 개별 규격이 없습니다.");
    expect(html).toContain("상품 규격 관리");
    expect(html).toContain("세부 규격 직접 수정");
    ...
    expect(html).toContain("생성 옵션");
    expect(html).toContain("GPT Image 2");
    expect(html).toContain("나노바나나 2");
    expect(html).toContain('name="stagingCount"');
    expect(html).toContain('name="stagingRatio"');
    expect(html).toContain('name="stagingResolution"');
    expect(html).toContain("0.5k");
    expect(html).toContain("2k");
    expect(html).not.toContain("품질 모드");
