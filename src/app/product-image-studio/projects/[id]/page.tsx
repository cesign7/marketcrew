...
type ProductImageStudioProjectDetailPageProps = {
  readonly params: Promise<{ readonly id: string }>;
};

export const dynamic = "force-dynamic";

export default async function ProductImageStudioProjectDetailPage({
  params,
}: ProductImageStudioProjectDetailPageProps) {
  ...
  return (
    <ProductImageStudioShell
      activePath={`/product-image-studio/projects/${detail.project.id}`}
      description="한 프로젝트의 생성 이미지를 출력 타입별로 확인합니다."
