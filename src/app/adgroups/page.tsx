...
export default async function AdgroupsPage({ searchParams }: AdgroupsPageProps) {
  ...
  return (
    <MarketingShell activePath="/adgroups" description="광고그룹별 켜짐/꺼짐 상태와 입찰·예산 요약을 확인합니다." filters={filters} title="광고그룹">
      <section className="page-stack">
        <AdgroupStateTable
          description="기본 정렬은 브랜드, 광고유형, 이름 오름차순입니다. 상태 토글은 실행 미리보기와 변경 권한 확인을 통과한 뒤 네이버 광고그룹에 반영합니다."
