...
import { getSearchAdKeywordInsightView } from "@/lib/persistence/searchAdRepository";
...
export async function GET(request: Request) {
  ...
  const data = await getSearchAdKeywordInsightView(parseSearchAdFilters(Object.fromEntries(url.searchParams)));
