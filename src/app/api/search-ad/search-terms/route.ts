...
import { getSearchAdSearchTermsView } from "@/lib/persistence/searchAdRepository";
...
export async function GET(request: Request) {
  ...
  const data = await getSearchAdSearchTermsView(parseSearchAdFilters(Object.fromEntries(url.searchParams)));
