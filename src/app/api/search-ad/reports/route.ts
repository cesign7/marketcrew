...
import { getSearchAdReportArchiveView } from "@/lib/persistence/searchAdRepository";
...
export async function GET(request: Request) {
  ...
  const data = await getSearchAdReportArchiveView(parseSearchAdFilters(Object.fromEntries(url.searchParams)));
