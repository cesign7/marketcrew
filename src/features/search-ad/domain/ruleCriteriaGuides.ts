...
export const RULE_PERIOD_GUIDE_ITEMS = [
  ...
  },
  {
    title: "조치 후보",
    value: "카드에 별도 표시",
    description: "전환 점검, 제외어, 소재·랜딩, 입찰, 키워드 추가, 타게팅처럼 실제 다음 행동 기준으로 나눕니다.",
  },
];

export const RULE_ACTION_GUIDE_ITEMS = [
  {
    title: "전환 점검",
    value: "중지보다 먼저",
    description: "전환은 있는데 매출이 0원이거나, 전환 기준이 확정되지 않은 브랜드는 성과 판단 전에 추적 설정을 확인합니다.",
  },
  {
    title: "제외어 후보",
    value: "파워링크 검색어",
    description: "충분한 클릭과 비용이 있는데 전환이 없으면 방어 키워드 여부를 먼저 보고 제외어 또는 입찰 하향 후보로 둡니다.",
  },
  {
    title: "소재·랜딩 점검",
    value: "쇼핑검색·소재",
    description: "쇼핑검색 검색어와 광고 소재는 상품명, 대표 이미지, 광고 문구, 랜딩 URL 적합도를 함께 확인합니다.",
  },
  {
    title: "키워드 추가",
    value: "성과 검색어",
    description: "전환과 매출이 확인된 실제 검색어는 등록 키워드나 유사 키워드 확장 후보로 분리합니다.",
  },
];
