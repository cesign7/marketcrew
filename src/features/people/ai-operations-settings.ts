...
> = {
  ...
  gro: {
    roleModel: "규칙 엔진이 잡은 저성과 키워드를 먼저 처리하고, 정해진 지표 밖의 키워드·기기·시간대 조합도 자유 탐색합니다.",
    responsibility: "네이버 키워드광고의 낮은 전환율, 주문 없는 클릭, 높은 CPA, 기기/시간대 차이를 조정안으로 만들고 필요한 광고 설정 근거를 요청합니다.",
    outputContract: "키워드, 기기, 시간대별 조정 이유, 예상 효과, 예산 상한, 중단 기준, 필요한 근거를 함께 보고합니다.",
  ...
  day: {
    roleModel: "LLM이 제안한 근거 후보와 규칙 엔진의 광고 성과 판정을 실제 원천 필드와 집계 기준으로 검증합니다.",
