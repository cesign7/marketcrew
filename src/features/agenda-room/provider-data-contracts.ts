        ...
        sourceFieldGroups: [
          {
            ...
            title: "keywordList[0]",
            description: "키워드 도구 응답에서 선택 전에 확인하는 원천 필드입니다.",
            fields: [
        ...
        sourceFieldGroups: [
          {
            ...
            description: "DataLab 검색 트렌드 응답에서 선택 전에 확인하는 전체 응답 필드입니다.",
            fields: [
        ...
        sourceFieldGroups: [
          {
            ...
            title: "최근 변경 주문 응답",
            description: "최근 변경 주문 목록에서 선택 전에 확인하는 응답 형태와 상세 조회용 필드입니다.",
            fields: [
          ...
          },
          {
            ...
            title: "주문 상세 응답",
            description: "주문 상세 응답에서 선택 전에 확인하는 응답 형태와 상품/금액 후보 필드입니다.",
            fields: [
        ...
        sourceFieldGroups: [
          {
            ...
            description: "영카트 브리지가 반환하는 선택 전 원천 집계 응답 필드입니다. 고객/주문 원문 행은 브리지 밖으로 내보내지 않습니다.",
            fields: [
