...
CREATE INDEX IF NOT EXISTS product_image_studio_assets_project_idx
  ON product_image_studio_assets (project_id, created_at DESC);

CREATE INDEX IF NOT EXISTS product_image_studio_generation_requests_project_idx
  ON product_image_studio_generation_requests (project_id, created_at DESC);

CREATE INDEX IF NOT EXISTS product_image_studio_results_project_idx
  ON product_image_studio_results (project_id, created_at DESC);

CREATE INDEX IF NOT EXISTS product_image_studio_download_bundles_project_idx
  ON product_image_studio_download_bundles (project_id, created_at DESC);

CREATE INDEX IF NOT EXISTS product_image_studio_usage_records_project_idx
  ON product_image_studio_usage_records (project_id, created_at DESC);
